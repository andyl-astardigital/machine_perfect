...
1. Shared engine (`mn/engine.js`): tokenizer, parser, evaluator, stdlib, dependency tracking, scope management, path utilities. Zero platform dependencies. Runs identically in browser and Node.
