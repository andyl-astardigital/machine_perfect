...
## Decision
Extract the engine into `mp/engine.js` as a standalone UMD module with zero platform dependencies. The frontend embeds a copy for single-file distribution. The backend imports it directly.
